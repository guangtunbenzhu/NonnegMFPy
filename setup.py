...
setup(
  ...
  download_url = 'https://github.com/guangtunbenzhu/NonnegMFPy/tarball/0.1.0', # I'll explain this in a second
  keywords = ['nonnegative', 'matrix factorization', 'iterative'], # arbitrary keywords
  classifiers = [],
)
